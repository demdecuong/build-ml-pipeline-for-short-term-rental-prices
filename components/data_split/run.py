...
def go(args):
    ...
    logging.info(f"Downloading artifact {args.data}")
    artifact_local_path = run.use_artifact(args.data).file()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, help="Input artifact to split (a CSV file)", required=True
    )
